...
export class DatabaseService implements OnInit {
    ...
    // <------------------ Test Link ------------------------------>
    // dbUrl = "https://devcrm.abacusdesk.com/basiq/api/index.php/";
    // uploadUrl = "https://devcrm.abacusdesk.com/basiq/api/uploads/";
    // downloadUrl = "https://devcrm.abacusdesk.com/basiq/api/uploads/Download_excel/";
    
    // <------------------ Demo Link ------------------------------>
    dbUrl = "https://demo.basiqcrm.com/api/index.php/";
    uploadUrl = "https://demo.basiqcrm.com/api/uploads/";
    downloadUrl = "https://demo.basiqcrm.com/api/uploads/Download_excel/";
