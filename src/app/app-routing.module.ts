...
const routes: Routes = [
  {path:'login/:type',component:LoginComponent,canActivate:[AuthGuard]},
  {path:'',component:LoginTypeComponent,canActivate:[AuthGuard]},
  ...
  { path: "redeem-request", loadChildren:'./redeem/redeem-request-module/redeem-request.module#RedeemRequestModule'},
