...
export class AddOrderComponent implements OnInit {
  ...
  getCode()
  {
    this.serve.post_rqst({},"Order/productCode").subscribe((result=>
      {
        console.log(result);
    ...
    getBrandColor(id)
    {
      this.serve.post_rqst({id},"Order/brandName").subscribe((result=>
        {
          console.log(result);
      ...
      ProductDetail(id)
      {
        this.serve.post_rqst({'dr_id':this.dr_id , id},"Order/productDetail").subscribe((result=>
          {
            console.log(result);
        ...
        submitOrder()
        {
          if(this.savingData == false)
          {
            ...
            this.serve.post_rqst({'item':this.orderItemList , 'data':this.Order_form },"Order/addChenalOrder")
            .subscribe(result=>
              {
